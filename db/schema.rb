...
ActiveRecord::Schema[8.1].define(version: 2026_04_08_100000) do
  ...
  create_table "role_change_logs", force: :cascade do |t|
    ...
    t.bigint "user_id", null: false
    t.index ["changed_at"], name: "index_role_change_logs_on_changed_at"
    t.index ["changed_by"], name: "index_role_change_logs_on_changed_by"
  ...
  create_table "templates", force: :cascade do |t|
    ...
    t.index ["private"], name: "index_templates_on_private"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "otp_secret"
    t.integer "permission_version", default: 0, null: false
