const en = {
  ...
  signer_name_field: 'Signer Name Field',
  send: 'Send',
  remove: 'Remove',
  edit: 'Edit',
  settings: 'Settings',
...
const es = {
  ...
  signer_name_field: 'Campo nombre del firmante',
  ...
  feature_not_available: 'Esta función no está disponible.',
...
const it = {
  ...
  signer_name_field: 'Campo nome del firmatario',
  send: 'Invia',
  remove: 'Rimuovi',
  edit: 'Modifica',
  ...
  feature_not_available: 'Questa funzione non è disponibile.',
...
const pt = {
  ...
  signer_name_field: 'Campo nome do signatário',
  ...
  feature_not_available: 'Este recurso não está disponível.',
...
const fr = {
  ...
  signer_name_field: 'Champ nom du signataire',
  send: 'Envoyer',
  remove: 'Supprimer',
  edit: 'Modifier',
  settings: 'Paramètres',
...
const de = {
  ...
  signer_name_field: 'Feld Name des Unterzeichners',
  send: 'Senden',
  remove: 'Entfernen',
  edit: 'Bearbeiten',
...
const nl = {
  ...
  signer_name_field: 'Veld naam ondertekenaar',
  send: 'Verzenden',
  remove: 'Verwijderen',
  edit: 'Bewerken',
  ...
  feature_not_available: 'Deze functie is niet beschikbaar.',
