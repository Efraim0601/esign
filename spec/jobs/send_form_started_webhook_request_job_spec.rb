...
RSpec.describe SendFormStartedWebhookRequestJob do
  ...
  describe '#perform' do
    ...
    it 'returns without sending when webhook url is missing' do
      described_class.new.perform('submitter_id' => submitter.id, 'webhook_url_id' => -1, 'event_uuid' => SecureRandom.uuid)
