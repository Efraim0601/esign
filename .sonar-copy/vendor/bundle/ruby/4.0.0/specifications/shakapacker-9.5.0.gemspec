# -*- encoding: utf-8 -*-
# stub: shakapacker 9.5.0 ruby lib

Gem::Specification.new do |s|
  s.name = "shakapacker".freeze
  s.version = "9.5.0".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "source_code_uri" => "https://github.com/shakacode/shakapacker/tree/v9.5.0" } if s.respond_to? :metadata=
